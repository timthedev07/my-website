...
An **indefinite integral** is written in the form of $\int y\,dx$, where $y$ is the **expression to be integrated (a.k.a the integrand)** and $x$ is the **variable to integrate with respect to**.
