...
<SizedImage alt="" src="https://raw.githubusercontent.com/timthedev07/my-website/dev/assets/integral-area-two-fs.png" width="1080" height="540" />


In this case, $y_1$ is the function of the curve and $y_2$ is the function of the
straight line, since in the required region, the curve is above the line.
