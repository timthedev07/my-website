...
<SizedImage alt="" src="https://raw.githubusercontent.com/timthedev07/my-website/dev/assets/cartesian-equilateral.png" width="910" height="602" />


Now, to generate a point within this bounded region we have to check for the following
inequalities:
...
<SizedImage alt="" src="https://raw.githubusercontent.com/timthedev07/my-website/dev/assets/p-in-equilateral.png" width="408" height="369" />


We can construct a triangle as follows:

<SizedImage alt="" src="https://raw.githubusercontent.com/timthedev07/my-website/dev/assets/p-in-equilateral-1.png" width="408" height="369" />


Notice that to get the area of it, there are **two** ways to do it with $\frac{
  bh
}
{2}$.
...
<SizedImage alt="" src="https://raw.githubusercontent.com/timthedev07/my-website/dev/assets/p-in-equilateral-2.png" width="408" height="369" />
