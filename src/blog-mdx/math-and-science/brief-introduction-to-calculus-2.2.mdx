...
<SizedImage
  alt=""
  src="https://raw.githubusercontent.com/timthedev07/my-website/dev/assets/area-curve-simple.png"
  width="656"
  height="489"
/>
...
<SizedImage
  alt=""
  src="https://raw.githubusercontent.com/timthedev07/my-website/dev/assets/area-curve-simple-2.png"
  width="656"
  height="489"
/>
...
<SizedImage
  alt=""
  src="https://raw.githubusercontent.com/timthedev07/my-website/dev/assets/sinx-integral-graph.png"
  width="588"
  height="522"
/>
...
<SizedImage
  alt=""
  src="https://raw.githubusercontent.com/timthedev07/my-website/dev/assets/area-curve-axis-both-eg.png"
  width="509"
  height="376"
/>
...
<SizedImage
  alt=""
  src="https://raw.githubusercontent.com/timthedev07/my-website/dev/assets/riemann-strips.png"
  width="767"
  height="530"
/>
...
<SizedImage
  alt=""
  src="https://raw.githubusercontent.com/timthedev07/my-website/dev/assets/riemann-labels.png"
  width="960"
  height="720"
/>
...
<SizedImage
  alt=""
  src="https://raw.githubusercontent.com/timthedev07/my-website/dev/assets/riemann-n-increase.gif"
  width="417"
  height="427"
/>

However, the value of $R(n)$ will never exceed a certain value no matter how large
$n$ becomes, and that limit is the exact area of the curve.
...
<SizedImage
  alt=""
  src="https://raw.githubusercontent.com/timthedev07/my-website/dev/assets/left-endpoint.png"
  width="767"
  height="530"
/>

In comparison, for a **_right endpoint sum_**, each rectangle's top-right corner
touches the curve, therefore the approximation will always be above the actual area.
...
<SizedImage
  alt=""
  src="https://raw.githubusercontent.com/timthedev07/my-website/dev/assets/right-endpoint.png"
  width="767"
  height="546"
/>

Finally, for a **_midpoint_** rule, the curve meets each strip at the midpoint of
...
<SizedImage
  alt=""
  src="https://raw.githubusercontent.com/timthedev07/my-website/dev/assets/midpoint-riemann.png"
  width="767"
  height="546"
/>
