...
For example, the point labelled in the image is a **minimum stationary point**.
...
In the image above, the labelled point is a **_minimum turning point_**, because from there, the function becomes increasing.
