  ...
  return (
    <>
      ...
      <div className="flex w-full justify-center items-center">
        <div className="justify-evenly flex mt-20 items-center border border-slate-400/40 rounded-xl bg-slate-700/10 flex-col gap-4 px-4 pt-10 pb-14 sm:flex-row sm:w-[95%] sm:px-5 sm:py-6 md:py-10 md:px-0 md:gap-4 md:w-10/12">
