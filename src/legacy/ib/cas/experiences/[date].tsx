...
import type { getAdjacentEntries } from "../../../../lib/ib-cas/experiences-mdx";
  ...
  return (
    <>
      <div className="w-full min-h-screen relative flex flex-col items-center">
        <div className="fixed z-0 blur-sm brightness-[0.4]">
          <ExperiencesBGSVG className="h-[150vh] landscape:w-screen landscape:h-auto object-cover blur-md" />
        </div>
