...
<CASStrandsHours creativityHours={4} activityHours={0} serviceHours={0} />

# CAS Stages

## Investigation & Preparation

Research will include gathering literature and analysing data. We will identify key areas and structure the report in an easy-to-follow manner. Tasks are to be divided among the two of us based on expertise and planned wisely according to time allocations and considerations of skills.
...
[Link](https://mathe-auf-deutsch.vercel.app/blog/deutsch-lernen/2024-08-01-zuwanderung)

<SizedImage
  width={2940}
  height={1680}
  alt="img"
  src={{ dir: "cas-evidence/global-engagement/zuwanderung", fname: "img.png" }}
/>
