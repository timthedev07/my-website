...
6. Demonstrate the skills and recognise the benefits of working collaboratively.
...
Lately, I have implemented a documentation page to explicitly establish expectations and convey key information, not for users to utilise the application correctly and ethically, but also to provide important guidance so students don't get lost, hence a higher customer satisfaction.
